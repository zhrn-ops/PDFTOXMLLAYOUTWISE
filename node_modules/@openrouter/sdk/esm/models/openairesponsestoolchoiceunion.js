...
/** @internal */
export const OpenAIResponsesToolChoiceTypeShell$inboundSchema = z.enum(OpenAIResponsesToolChoiceTypeShell);
/** @internal */
export const OpenAIResponsesToolChoiceTypeShell$outboundSchema = OpenAIResponsesToolChoiceTypeShell$inboundSchema;
/** @internal */
export const OpenAIResponsesToolChoiceShell$inboundSchema = z.object({
    type: OpenAIResponsesToolChoiceTypeShell$inboundSchema,
});
/** @internal */
export const OpenAIResponsesToolChoiceShell$outboundSchema = z.object({
    type: OpenAIResponsesToolChoiceTypeShell$outboundSchema,
});
export function openAIResponsesToolChoiceShellToJSON(openAIResponsesToolChoiceShell) {
    return JSON.stringify(OpenAIResponsesToolChoiceShell$outboundSchema.parse(openAIResponsesToolChoiceShell));
}
export function openAIResponsesToolChoiceShellFromJSON(jsonString) {
    return safeParse(jsonString, (x) => OpenAIResponsesToolChoiceShell$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'OpenAIResponsesToolChoiceShell' from JSON`);
}
/** @internal */
export const OpenAIResponsesToolChoiceTypeApplyPatch$inboundSchema = z.enum(OpenAIResponsesToolChoiceTypeApplyPatch);
/** @internal */
export const OpenAIResponsesToolChoiceTypeApplyPatch$outboundSchema = OpenAIResponsesToolChoiceTypeApplyPatch$inboundSchema;
/** @internal */
export const OpenAIResponsesToolChoiceApplyPatch$inboundSchema = z.object({
    type: OpenAIResponsesToolChoiceTypeApplyPatch$inboundSchema,
});
/** @internal */
export const OpenAIResponsesToolChoiceApplyPatch$outboundSchema = z.object({
    type: OpenAIResponsesToolChoiceTypeApplyPatch$outboundSchema,
});
export function openAIResponsesToolChoiceApplyPatchToJSON(openAIResponsesToolChoiceApplyPatch) {
    return JSON.stringify(OpenAIResponsesToolChoiceApplyPatch$outboundSchema.parse(openAIResponsesToolChoiceApplyPatch));
}
export function openAIResponsesToolChoiceApplyPatchFromJSON(jsonString) {
    return safeParse(jsonString, (x) => OpenAIResponsesToolChoiceApplyPatch$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'OpenAIResponsesToolChoiceApplyPatch' from JSON`);
}
/** @internal */
