...
export type UpdateBYOKKeyGlobals = {
    /**
...
export type UpdateBYOKKeyRequest = {
     ...
     */
    id: string;
    updateBYOKKeyRequest: models.UpdateBYOKKeyRequest;
};
/** @internal */
export type UpdateBYOKKeyRequest$Outbound = {
    ...
    appCategories?: string | undefined;
    id: string;
    UpdateBYOKKeyRequest: models.UpdateBYOKKeyRequest$Outbound;
};
/** @internal */
...
//# sourceMappingURL=updatebyokkey.d.ts.map