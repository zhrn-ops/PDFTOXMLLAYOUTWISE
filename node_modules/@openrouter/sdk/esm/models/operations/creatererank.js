...
/** @internal */
export const DocumentRequest$outboundSchema = z.object({
    image: z.string().optional(),
    text: z.string().optional(),
});
export function documentRequestToJSON(documentRequest) {
    return JSON.stringify(DocumentRequest$outboundSchema.parse(documentRequest));
}
/** @internal */
export const Document$outboundSchema = z
...
export const CreateRerankRequestBody$outboundSchema = z.object({
    documents: z.array(z.union([z.string(), z.lazy(() => DocumentRequest$outboundSchema)])),
    model: z.string(),
...
/** @internal */
export const DocumentResponse$inboundSchema = z.object({
    image: z.string().optional(),
    text: z.string().optional(),
});
export function documentResponseFromJSON(jsonString) {
    return safeParse(jsonString, (x) => DocumentResponse$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'DocumentResponse' from JSON`);
}
/** @internal */
