...
async function $do(client, request, options) {
    const parsed = safeParse(request, (value) => operations.GetModelRequest$outboundSchema.parse(value), "Input validation failed");
    if (!parsed.ok) {
    ...
    const path = pathToFunc("/model/{author}/{slug}")(pathParams);
...
//# sourceMappingURL=modelsGet.js.map