 ...
 */
export function presetsCreatePresetsResponses(client, request, options) {
    return new APIPromise($do(client, request, options));
}
async function $do(client, request, options) {
    const parsed = safeParse(request, (value) => operations.CreatePresetsResponsesRequest$outboundSchema.parse(value), "Input validation failed");
    if (!parsed.ok) {
    ...
    const path = pathToFunc("/presets/{slug}/responses")(pathParams);
...
//# sourceMappingURL=presetsCreatePresetsResponses.js.map