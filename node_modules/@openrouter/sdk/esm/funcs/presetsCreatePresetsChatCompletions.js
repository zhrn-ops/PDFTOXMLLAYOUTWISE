 ...
 */
export function presetsCreatePresetsChatCompletions(client, request, options) {
    return new APIPromise($do(client, request, options));
}
async function $do(client, request, options) {
    const parsed = safeParse(request, (value) => operations.CreatePresetsChatCompletionsRequest$outboundSchema.parse(value), "Input validation failed");
    if (!parsed.ok) {
    ...
    const path = pathToFunc("/presets/{slug}/chat/completions")(pathParams);
...
//# sourceMappingURL=presetsCreatePresetsChatCompletions.js.map