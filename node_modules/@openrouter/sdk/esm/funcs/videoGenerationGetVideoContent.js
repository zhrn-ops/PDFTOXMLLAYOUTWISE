 ...
 */
export function videoGenerationGetVideoContent(client, request, options) {
    return new APIPromise($do(client, request, options));
}
async function $do(client, request, options) {
    const parsed = safeParse(request, (value) => operations.ListVideosContentRequest$outboundSchema.parse(value), "Input validation failed");
    if (!parsed.ok) {
...
//# sourceMappingURL=videoGenerationGetVideoContent.js.map