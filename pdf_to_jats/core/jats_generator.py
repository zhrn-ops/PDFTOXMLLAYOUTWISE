...
class JATSGenerator:
    ...
    def _append_body(self, parent: Any, document: Document) -> None:
        ...
        for paragraph in paragraphs:
            ...
            para.text = self._sanitize_xml_text(paragraph.text)
    ...
    def _append_item_info(self, parent: Any, document: Document) -> None:
        ...
        default_itemids = [("OSIN", "00000000"), (abstract_number, "ABS0")]
    ...
    def _append_head(self, parent: Any, document: Document) -> None:
        ...
        titletext.text = self._sanitize_title(document.title) or "Untitled"
        ...
        if document.abstract:
            ...
            para.text = self._sanitize_xml_text(document.abstract)
    ...
    def _sanitize_title(self, value: str | None) -> str:
        ...
        text = self._sanitize_xml_text(value).strip()
        if not text:
            return ""
