...
class PDFExtractor:
    ...
    def extract(self, pdf_path: str | Path) -> Document:
        ...
        abstract_number, abstract_number_block_ids = self._extract_abstract_number(document.blocks)
        if abstract_number:
            document.metadata["abstract_number"] = abstract_number
            if abstract_number_block_ids:
                document.metadata["abstract_number_block_ids"] = abstract_number_block_ids
